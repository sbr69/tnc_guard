...
export const mockDocuments: Document[] = [
  {
    id: 'acme-tos',
    title: 'Acme Cloud Services Terms of Service',
    type: 'tos',
    ...
    clauses: [
      ...
      },
      {
        ...
        riskLevel: 'low',
        originalText: 'YOU RETAIN ALL OWNERSHIP, COPYRIGH, AND INTELLECTUAL PROPERTY RIGHTS IN THE TEXT, DATA, IMAGES, OR CONTENT THAT YOU SUBMIT, POST, OR UPLOAD TO THE PLATFORM.',
  ...
  {
    id: 'cozy-haven-lease',
    title: 'Cozy Haven Residential Lease Agreement',
    type: 'lease',
